...
function setup() {
  ...
  video[1] = createVideo( data.videos.p2 ); // string
  video[2] = createVideo( data.videos.p3 ); // string
  video[3] = createVideo( data.videos.p4 ); // string
  video[4] = createVideo( data.videos.p5 ); // string
  video[5] = createVideo( data.videos.p6); // string
  video[6] = createVideo( data.videos.p7 ); // string
